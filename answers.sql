...
SELECT * FROM models WHERE brand_name=
'Pontiac';
...
SELECT models.name, models.brand_name, brands.headquarters FROM models JOIN brands ON models.brand_name=brands.name WHERE brands.name='Ford' AND models.name='Mustang';
...
SELECT models.name, brand_name, brands.founded FROM models LEFT JOIN brands
